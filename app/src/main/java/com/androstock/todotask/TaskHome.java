...
public class TaskHome extends AppCompatActivity {
    ...
    public static String KEY_PRIORITY = "pri";
    public static String KEY_STATUS = "stat";
    ...
    public void loadDataList(Cursor cursor, ArrayList<HashMap<String, String>> dataList)
    {
        if(cursor!=null ) {
            ...
            while (cursor.isAfterLast() == false) {
                ...
                mapToday.put(KEY_STATUS, cursor.getString(5).toString());
    ...
    public void loadListView(ListView listView, final ArrayList<HashMap<String, String>> dataList)
    {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                delid = dataList.get(+position).get(KEY_ID);

                Log.d("hiii","intel"+delid);
            }
        });
    }
