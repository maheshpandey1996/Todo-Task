...
public class ListTaskAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.priorityView = (TextView) convertView.findViewById(R.id.priorityTextView);
        ...
        holder.priorityView.setId(position);
        holder.task_status.setId(position);
        ...
        try{
            ...
            holder.priorityView.setText(song.get(TaskHome.KEY_PRIORITY));
            holder.task_status.setText(song.get(TaskHome.KEY_STATUS));
...
class ListTaskViewHolder {
    TextView task_image;
    TextView task_name, task_date, task_time, priorityView,task_status ;
